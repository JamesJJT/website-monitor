                ...
                <div>
                    ...
                    <div class="mt-6 sm:mt-5 space-y-6 sm:space-y-5">
                        ...
                        <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                            ...
                            <div class="mt-1 sm:mt-0 sm:col-span-2">
                                <input type="text" name="owner" id="owner" class="max-w-lg block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs sm:text-sm border-gray-300 rounded-md">
                            </div>
                        </div>
                        <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                            <label for="github_url" class="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2"> Github Url </label>
                            <div class="mt-1 sm:mt-0 sm:col-span-2">
                                <input type="text" name="github_url" id="github_url" class="max-w-lg block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs sm:text-sm border-gray-300 rounded-md">
                            </div>
                        </div>
                        <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                            <label for="documentation_url" class="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2"> Documentation Url </label>
                            <div class="mt-1 sm:mt-0 sm:col-span-2">
                                <input type="text" name="documentation_url" id="documentation_url" class="max-w-lg block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs sm:text-sm border-gray-300 rounded-md">
                            </div>
                        </div>
                    </div>
                </div>
